...
#define _OS_STACK_SIZE 64 // stack size in words (long)
#define _OS_MAX_THREADS 8
#define _OS_FREE_THREAD -1
#define OS_ARBITRARY_DELAY 50
#define _OS_FIFO_SIZE 32  // must be power of 2
#define PF1 (*(volatile unsigned long *)0x40025000 + 0x80)
#define PORTF_PINS 0x02
#define PORTE_PINS 0x02
#define TIME_1MS  50000          
#define TIME_2MS  2*TIME_1MS  

typedef struct OS_SemaphoreType {
  long value;
  // add a list of threads blocked on this semaphore?
} OS_SemaphoreType;

//typedef int *OS_SemaphoreType;
