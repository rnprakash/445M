...
// Output: 0 if successful and 1 on failure (e.g., trouble writing to flash)
int eFile_Create(char name[FILE_NAME_SIZE]);  // create new file, make it empty 
...
// Output: 0 if successful and 1 on failure (e.g., trouble writing to flash)
int eFile_WOpen(char name[FILE_NAME_SIZE]);      // open a file for writing 
...
int eFile_ROpen(char name[FILE_NAME_SIZE]);      // open a file for reading 
...
// Input: file name is a single ASCII letter
// Output: 0 if successful and 1 on failure (e.g., trouble writing to flash)
int eFile_Delete(char name[FILE_NAME_SIZE]);  // remove this file 
